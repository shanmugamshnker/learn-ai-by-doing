"""
IIT Bombay Library Agent - FastAPI with AI-Powered Search
==========================================================
Uses OpenAI to understand natural language queries and search the catalog.

Run: python -m iit_bombay_library_agent.agent
...
from iit_bombay_library_agent.catalog import (
...
LIBRARY_NAME = "IIT Bombay Central Library"
PORT = 8004
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "genre": {
                        "type": "string",
                        "description": "Optional genre to filter recommendations (e.g., 'Artificial Intelligence', 'Computer Science')"
                    }
                },
                "required": []
            }
...
Always use the available tools to search and respond. Be helpful and concise."""
    ...
    try:
        ...
        if results:
            ...
            return response
        return f"I couldn't process your request. Try searching for specific terms like 'machine learning' or 'algorithms'."
